...
console.log(finalScore(inning, 9), 'task 3')
...
console.log(getInningScore(inning), 'task 4')
...
function scoreboard(getInningScoreCB, inningCB, numInningsPlayed) {
    const scoreByInning = [];
    let homeScore = 0;
    let awayScore = 0;
      for(let i = 0; i < numInningsPlayed; i++) {
